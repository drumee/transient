...
const { Behavior } = require("backbone.marionette");
class __bhv_flyover extends Behavior {
  constructor(...args) {
    super(...args);
  ...
  static initClass() {
    if (window.PointerEvent) {
      this.prototype.events = {
        pointerenter: '_trigger',
        pointerleave: '_trigger',
        pointermove: '_trigger',
        pointerout: '_trigger',
        pointerover: '_trigger'
      };
    } else {
      this.prototype.events = {
        mouseenter: '_trigger',

const { arcLength } = require("../../utils")
const __progess = require('../../template/progress');
const { uploadFile } = require("../../socket/upload");
const { CoreMfs } = require("../../mfs");
const Loader = new Map();

require('./skin');

class Avatar extends CoreMfs {

...
function _path(path_id, stroke_array, stroke, moreClass, stroke_offset) {
...
class __circle_percent extends LetcBox {
  ...
  update() {
    ...
    let content = this.mget(_a.label)
    const legend = Skeletons.Note({ content, className: "chart__text chart__text--small" });

...
const { toArray, Cache, Attr, Constants, Messenger, sysEnv } = require('@drumee/server-essentials');
...
class Register extends __butler {
    ...
    async _handleOAuthCallback(provider) {
        ...
        await this.yp.await_query(
            'INSERT INTO yp.oauth_accounts (user_id, provider, provider_user_id, email, ctime, mtime) VALUES (?, ?, ?, ?, UNIX_TIMESTAMP(), UNIX_TIMESTAMP())',
            newUserId, 
            provider, 
            provider_id, 
            email
